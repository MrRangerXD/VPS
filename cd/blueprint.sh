...
install_zensei() {
    echo ">>> Starting Fresh Install for Zensei Hosting..."
    ...
    echo ">>> Downloading latest Zensei Hosting release..."
    ...
    # --- Step 3: Run Zensei Hosting Installer ---
...
reinstall_zensei() {
    echo ">>> Starting Reinstall for Zensei Hosting..."
    blueprint -rerun-install
}

# Function: Update Zensei Hosting
update_zensei() {
    echo ">>> Starting Update for Zensei Hosting..."
    blueprint -upgrade
